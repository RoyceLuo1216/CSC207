...
On Sunday, Skye used the auto-scheduler to create a studying inMemoryDataAccessObject to prepare for her Math and English tests on 
...
study for Math anymore. The scheduler outputs a new inMemoryDataAccessObject for the rest of the week (Wednesday to Sunday) where Skye 
